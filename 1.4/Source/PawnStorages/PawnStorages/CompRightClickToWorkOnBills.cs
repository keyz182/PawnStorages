...
public class CompRightClickToWorkOnBills : ThingComp
{
    ...
    public CompProperties_RightClickToWorkOnBills Props =>
        props as CompProperties_RightClickToWorkOnBills;
